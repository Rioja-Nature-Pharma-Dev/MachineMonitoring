...
public sealed class MachineParameterDefinitionConfiguration : IEntityTypeConfiguration<MachineParameterDefinition>
{
    public void Configure(EntityTypeBuilder<MachineParameterDefinition> builder)
    {
        builder.ToTable("machine_parameter_definitions");
